			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse">
					...
					<ul class="nav navbar-nav navbar-right">
						<li><a href="javascript:void(0);"
							onclick=""> Ambar 
								${ambar.ad} |  Açılış tarihi: ${ambar.olusturmaTarihi}
						</a></li>
					</ul>
				</div>
			</div>
				...
				<div class="col-sm-2 sidenav">
					<ul class="nav nav nav-stacked">
						<li class="active"><a href="javascript:void(0);"
							id="hesabim"><span class="glyphicon glyphicon-user"></span>
								Hesabım</a></li>
						<li class="active"><a href="javascript:void(0);"
							id="ambarim"><span class="glyphicon glyphicon-user"></span>
								Ambarım</a></li>		
						<!-- <li class="active"><a href="javascript:void(0);"
							id="adres"><span class="fa fa-paper-plane"
								aria-hidden="true"></span> Adres List</a></li> -->
						<li class="active"><a href="javascript:void(0);"
							onclick="gonderiForm('form/ambar')"><i class="fa fa-address-card-o"></i>
								Ambarımı Güncelle</a></li>
						<li class="active"><a href="javascript:void(0);"
							id="tarifeler"><i class="fa fa-address-card-o"></i>
								Tarifeler</a></li>
